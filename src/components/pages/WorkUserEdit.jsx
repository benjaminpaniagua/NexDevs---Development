        ...
        <>
            ...
            <div>
                ...
                <form className='flex flex-col mx-auto px-20 max-w-[100rem] md:px-10 h-auto' onSubmit={handleSubmit}>
                    ...
                    {editError && <p className="text-red-500 text-fs-med flex justify-center mt-2">{editError}</p>}
                    {editLoading && <p className="text-clr-green text-fs-med flex justify-center mt-2">Cargando...</p>}
                    {skillisEqual && <p className="text-red-500 text-fs-med flex justify-center mt-2">Las habilidades no pueden ser iguales</p>}
                    {categoryisEqual && <p className="text-red-500 text-fs-med flex justify-center mt-2">Las categorías no pueden ser iguales</p>}
