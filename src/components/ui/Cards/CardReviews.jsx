    ...
    return (
        <>
            ...
            <div className='bg-clr-black h-auto flex gap-5 rounded-2xl py-6 px-4' onClick={onClick}>
                {/* Profile Picture */}
                <img className='w-14 rounded-full border-2 border-white py-auto' src={profilePicture} alt="" />
                {/* Profile Picture */}
                ...
                <div className="flex gap-1 my-auto ml-auto">
                    {Array.from({ length: 5 }, (_, index) => (
                        <svg key={index} className={`w-8 xs:w-2.5`} viewBox="0 0 37 37" xmlns="http://www.w3.org/2000/svg">
