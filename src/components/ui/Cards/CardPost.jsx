                        ...
                        <div className="flex gap-3 xs:gap-1 items-center ml-auto">
                            <button className="transition-all hover:scale-110">
                                <svg className="w-7 xs:w-5 fill-none stroke-clr-black transition-all hover:stroke-clr-blue" viewBox="0 0 28 25" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M22.9551 3.15984C19.7371 1.24077 16.9285 2.01413 15.2413 3.24601C14.5494 3.75112 14.2035 4.00367 14 4.00367C13.7965 4.00367 13.4506 3.75112 12.7587 3.24601C11.0715 2.01413 8.26291 1.24077 5.04493 3.15984C0.821683 5.67843 -0.133936 13.9874 9.60743 20.9973C11.4629 22.3324 12.3906 23 14 23C15.6094 23 16.5372 22.3324 18.3926 20.9973C28.134 13.9874 27.1783 5.67843 22.9551 3.15984Z" stroke-width="2.4" stroke-linecap="round" />
                                </svg>
                            </button>
