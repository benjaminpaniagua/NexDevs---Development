                        ...
                        (
                            <div className="flex flex-col">
                                ...
                                <div className="flex flex-col mt-28">
                                    ...
                                    <h4 className="font-bold text-clr-grey md:text-center">{users.city}, {users.province}</h4>
                                </div>
                                {/* Profile data */}
                                {/* Stars */}
                                ...
                                {/* Stars */}
                                {/* Botones */}
                                <div className="flex md:flex-col gap-5 justify-center items-center my-2">
                                    <SecondaryButtonOutline text={"Editar Perfil"} extraStyles={"w-1/3 md:w-full py-2"} />
                            ...
                            <div className="flex flex-col">
                                ...
                                {token &&
                                    <div className="flex gap-5 justify-center items-center my-2">
                                        <SecondaryButtonOutline text={"Dejar una Reseña"} extraStyles={"w-full py-2"} />
                                    </div>
                                }
                                {!token &&
                                    <div className="flex gap-5 justify-center items-center my-2">
